...
HISTORY_CSV = r"D:\CT_Brain_StudyWise_Project\results\regularized_mil_history.csv"
...
def build_model():
    ...
    x = AttentionMIL(attention_dim=64)(inp)
...
def main():
    print("=" * 70)
    print("REGULARIZED ATTENTION MIL TRAINING")
    print("=" * 70)
